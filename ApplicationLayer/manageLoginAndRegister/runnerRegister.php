...
function checkAvailability() {
    ...
    data:'runnerusername='+$("#runnerusername").val(),
    type: "POST",
            ...
            <div class="row">
                <div class="col-lg-4 col-lg-offset-4">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control form-control input-lg" name="runnerusername" id="runnerusername" placeholder="Username" onBlur="checkAvailability()" required>
                    </div>
