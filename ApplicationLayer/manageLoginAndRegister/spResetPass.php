...
<html>
    <head>
        <title>Service Provider's Password Recovery</title>
        <meta charset="UTF-8">
    ...
    <body>
        ...
        <br>
        <p><strong>Service Provider's Password Recovery</strong>:</p>
        <br>
            ...
            <div class="row">
                <div class="col-lg-4 col-lg-offset-4">
                    ...
                    <div class="input-group">         
                        ...
                        <input type="password" class="form-control form-control input-lg" name="sppassword" id="password" placeholder="New Password" required>
                        <input type="password" class="form-control form-control input-lg" name="sppassword1" id="password" placeholder="Confirm Password" required>
                    </div>
